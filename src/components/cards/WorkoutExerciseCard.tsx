...
const WorkoutExerciseCard = ({ exerciseDetails }: {exerciseDetails: ExerciseType}) => {
  ...
  return (
    <Link to={`/exerciseDetails/${exerciseDetails.id}`} className='bg-SecondaryBackgroundColor p-4 rounded-md'>
      <h1 className='text-[#1491ff] text-lg capitalize font-semibold'> {exerciseDetails.exercise_name} </h1>
